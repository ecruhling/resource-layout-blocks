					...
					<FlexItem>
						<SelectControl label={__('Display', 'resource')}
													 ...
													 options={[
														 ...
														 {value: `d-${breakpoint}block`, label: __('Block', 'resource')},
														 {value: `d-${breakpoint}grid`, label: __('Grid', 'resource')},
														 {
															 value: `d-${breakpoint}inline-grid`,
															 label: __('Inline Grid', 'resource'),
														 },
														 {value: `d-${breakpoint}table`, label: __('Table', 'resource')},
														 {
														 ...
														 {value: `d-${breakpoint}flex`, label: __('Flex', 'resource')},
														 {
