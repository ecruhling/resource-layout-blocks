			...
			content:
				<Card>
					<DisplayControl
						...
						breakpoint_name={css_class}
						display={display}
						setDisplay={display => setAttributes({display})}
					></DisplayControl>
					{(display === 'd-' + css_class + 'flex' || display === 'd-' + css_class + 'inline-flex') && (
						<FlexControl
							breakpoint={css_class}
							breakpoint_name={css_class}
							...
							setFlexDirection={flexDirection => setAttributes({flexDirection})}
							setJustifyContent={justifyContent => setAttributes({justifyContent})}
							setAlignItems={alignItems => setAttributes({alignItems})}
							setAlignSelf={alignSelf => setAttributes({alignSelf})}
							setFillGrowShrink={fillGrowShrink => setAttributes({fillGrowShrink})}
							setWrap={wrap => setAttributes({wrap})}
							setOrder={order => setAttributes({order})}
							setAlignContent={alignContent => setAttributes({alignContent})}
						>
						</FlexControl>
					)}
					{(display !== 'd-' + css_class + 'none') && (
						<>
							<PaddingControl
								...
								setPaddingTop={paddingTop => setAttributes({paddingTop})}
								setPaddingRight={paddingRight => setAttributes({paddingRight})}
								setPaddingBottom={paddingBottom => setAttributes({paddingBottom})}
								setPaddingLeft={paddingLeft => setAttributes({paddingLeft})}
							></PaddingControl>
							<MarginControl
								breakpoint={css_class}
								breakpoint_name={css_class}
								...
								setMarginTop={marginTop => setAttributes({marginTop})}
								setMarginRight={marginRight => setAttributes({marginRight})}
								setMarginBottom={marginBottom => setAttributes({marginBottom})}
								setMarginLeft={marginLeft => setAttributes({marginLeft})}
							></MarginControl>
							<AlignControl
								breakpoint={css_class}
								breakpoint_name={css_class}
								alignText={alignText}
								setAlignText={alignText => setAttributes({alignText})}
							></AlignControl>
						</>
					)}
				</Card>,
